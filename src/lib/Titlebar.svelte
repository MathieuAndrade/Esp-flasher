<script lang="ts">
  ...
  import { ToolbarButton, ToolbarGroup } from "flowbite-svelte";
</script>

<div
  class="flex justify-between items-center rounded-t-lg"
  data-tauri-drag-region
>
  <div class="flex items-center">
    <img src="/icon.png" class="h-5 mx-3" alt="Flowbite Logo" />
    <span class="self-center font-semibold"> Esp Flasher </span>
  </div>
  <ToolbarGroup>
    <!--
    <ToolbarButton on:click={() => console.log("help click")}>
      <svg
    ...
    <ToolbarButton on:click={() => console.log("settings click")}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        class="w-6 h-6"
    ...
    -->
    <ToolbarButton on:click={() => appWindow.minimize()}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        class="w-6 h-6"
    ...
    <ToolbarButton on:click={() => appWindow.close()}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        class="w-6 h-6"
